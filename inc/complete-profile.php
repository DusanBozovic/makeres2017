<div id="complete-profile" class="popup-form-wrapper">
	<div class="sign-container">
		...
		<form class="mr-form">
			...
			<p class="info-message">By creating your account, you agree to make-reservations.com <a href="#">Privacy Policy</a> and <a href="#">Terms of Use</a>.</p>
			<div class="section-buttons">
				<button href="#" class="button right" type="button">Join Now</button>
